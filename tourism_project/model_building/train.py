...
mlflow.set_experiment("tourism-project-experiment")     # complete the code to set the MLflow experiment name (same as the dev experimentation cell)
...
param_grid = {
    'xgbclassifier__n_estimators': [50,75,100],        # Number of boosting trees. More trees can improve performance but increase training time.
...
with mlflow.start_run():
    ...
    model_path = "tourism_project/deployment/best_tourism_package_model_v1.joblib"   # Specify the local file path (inside tourism_project/deployment/) where the trained model should be saved.
